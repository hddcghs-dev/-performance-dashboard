...
### 飞书多维表格（主力）
- **民德业绩看板-新**: 24店×57字段月度数据
  - Base Token: `SIwGb8hWvaIMDdsIysycBJ1EnOt`
  - 数据表 (tbl1DVnqDDU6Ro8z): 每月24条记录（含泉州兴贤路店）
  - 门店台账 (tblUiwpfn3YhGAWd): 24店基础信息，决定门店排列顺序
- **日报看板**: 日报数据，项目数/商品数/美团评分的来源
...
4. `lark-cli base +record-upsert` 逐条写入（每店一条，24条）
5. 项目数/商品数/美团经营分从"日报看板" Base拉取
6. 排序值按门店台账顺序写1-24
7. 泉州兴贤路店：无抖音数据，美团极少
